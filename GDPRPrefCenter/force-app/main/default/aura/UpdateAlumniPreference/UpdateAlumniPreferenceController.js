({
    ...
    doInit : function(component, event, helper) { 
        ...
        helper.getRegionPicklist(component, event, helper);
    ...
    handleSubmit : function(component, event, helper) {
        ...
        //component.set('v.preference.AB_Tech_Alumni__c', component.get('AB_Tech_Alumni__c'));
        /*var abthing = component.get("v.pref.AB_Tech_Alumni__c")
        var test1 = component.find("AB_Tech_Alumni__c");
        var test2 = test1.get("v.value");
        var test = component.find('AB_Tech_Alumni__c').get('v.checked');
        alert('well ' + test);*/
        debugger; 
        var test1 = component.get("v.region2");
        var test2 = component.get("v.region3");
        component.set('v.pref.Preferred_Region_3__c', component.get("v.region3"));
        component.set('v.pref.Preferred_Region_2__c', component.get("v.region2"));
    ...
    onCheck : function(component, event, helper) {
        var fvalue = component.find("unsubscribeAllFooter").get("v.value");
        var hvalue = component.find("unsubscribeAll").get("v.value");
        if (hvalue != fvalue) {
            component.find("unsubscribeAllFooter").set("v.value", hvalue);
        }
        if (hvalue == true ) {
            helper.getchangeFieldSetMemberValues(component, event, helper);
        }       
    },
    ...
    onCheckFooter : function(component, event, helper) {
        var fvalue = component.find("unsubscribeAllFooter").get("v.value");
        var hvalue = component.find("unsubscribeAll").get("v.value");
        if (hvalue != fvalue) {
            component.find("unsubscribeAll").set("v.value", fvalue);
        }
        if (fvalue == true ) {
            helper.getchangeFieldSetMemberValues(component, event, helper);
        } 
    },
    onFieldMemberChange : function(component, event, helper) {
        var fieldSetLocalId = event.getSource().getLocalId().split("checkbox")[0];
        var field = event.getSource();
        
        if(field.get("v.value") == true) {
            var unsubscribeAllField = component.find("unsubscribeAll");
            var unsubscribeAllFieldFooter = component.find("unsubscribeAllFooter");
            if(unsubscribeAllField.get("v.value") == true) {
                unsubscribeAllField.set("v.value", false);
            }
            if(unsubscribeAllFieldFooter.get("v.value") == true) {
                unsubscribeAllFieldFooter.set("v.value",false);
            }
